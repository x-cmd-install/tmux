...
合计: **111,773** 行代码（覆盖前 5 种语言、共 **387** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| C | 85,384 | 9,307 | 13,007 | 199 |
| Sh | 17,236 | 3,153 | 3,080 | 155 |
| CHeader | 5,228 | 683 | 715 | 9 |
...
- **Star**: 49,172 · **Fork**: 2,882 · **开放 issue**: 4,184 · **贡献者**: 16

## 累计统计

- **发布数**: 45 · **已合并 PR**: 37 · **开放 PR**: 15 · **已关闭 issue**: 4168 · **开放 issue**: 16 · **提交数**: 12127
...
_数据快照: `data/card/260910.yml` · 2026-09-10T22:10:52Z._
